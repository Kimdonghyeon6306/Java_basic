...
public class EscapeChar {
	...
	public static void main(String[] args) {
		/*
		Escape문자:출력시 원하는 형식에 맞게 출력하기 위해 사용하는 문자로
		특정 문자 앞에 \을 붙이면 
		그 특정 문자는 어떤 특수한 기능을 함.
		...
		*/
		...
		//문자열을 '(싱글 쿼테이션)으로 감싸도 되는 곳에서는 의미 있다.
		...
		//printf("형식 문자열",값들을 콤마로 구분해서 나열).단,printf는 줄바꿈 기능이 없다
		...
		/*
		   ...
		   12_ _
		   */
		System.out.println("[출력 자리 수 미 지정]");
		System.out.printf("국어:%d,영어:%d,수학:%d,평균:%f%n",kor,eng,math,avg);
		System.out.println("[출력 자리 수 지정(양수)]");
		System.out.printf("국어:%4d,영어:%4d,수학:%4d,평균:%7.2f%n",kor,eng,math,avg);
		System.out.println("[출력 자리 수 지정(음수)]");
		...
		System.out.println("==============================");
		System.out.printf("%17s%n","자바반 성적표");
		System.out.println("==============================");
