...
public class SilsuType {
	...
	public static void main(String[] args) {
		...
		//규칙1]정수형과 실수형을 연산시 연산 결과는 실수형이다.(실수형이 정수형보다 큰 그릇이라고 생각하자)
		//long(정수형):8byte,float(실수형):4byte
		long ln = 100;
		float f1 =200;
		//long ln1 = ln+f1;//[x]long형과 float형 연산 결과는 float
		//방법1)연산결과인 float형에 저장
		float f2 = ln+f1;
		System.out.println("f2="+f2);
		//방법2)연산결과를 long형으로 변환
		long ln1 = (long)(ln+f1);//[o]
		...
		//방법2)실수 숫자뒤에 f 나 F(권장)
		 ...
		 System.out.println("f3="+f3);
		//규칙3]실수형도 같은 자료형끼리의 연산 결과는 같은 자료형,
		...
		//면적을 저장하는 변수
		 ...
		 d1=0.1;
		 d2=0.2;
		 System.out.println(d1+d2);//예상:0.3,실제:0.30000000000000004 Floating Point Error
